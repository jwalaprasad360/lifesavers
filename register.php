...
<br>    
                   ...
                   <a href="login.php"style="color:black; background-color:#E3FDF5"class="form-input" >Login</a>
                </div>
                </form>
                </div>
                <?php
                    if(isset($_POST['register']))
                    {
                        ...
                        $q1="SELECT username FROM creds where username='$username'";
                        ...
                        {
                            echo "<script>
                            alert('user name already exist please choose different one');
                            </script>";
                        }
                        ...
                        else
                        {
                            ...
                            $q="INSERT INTO creds
                            VALUES ('$unqid','$username','$phone','$email','$password')";
                            $q2="INSERT INTO additional_data (unqid)
                            VALUES ('$unqid')";
                            $_SESSION['unqid']=$unqid;
